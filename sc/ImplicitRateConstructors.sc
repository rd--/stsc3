...
+ RExpRandN { *new { arg numChannels = 1.0, lo = 0.0, hi = 1.0; ^RExpRandN.performList('scalar'.rateToSelector, [numChannels, lo, hi]) } }
+ RRandN { *new { arg numChannels = 1.0, lo = 0.0, hi = 1.0; ^RRandN.performList('scalar'.rateToSelector, [numChannels, lo, hi]) } }
