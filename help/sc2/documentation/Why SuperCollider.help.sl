...
Computer music composition is a specification problem.
...
It has class objects, methods, dynamic typing, full closures, default arguments, variable length argument lists, multiple assignment, etc.
The implementation provides fast, constant time method lookup, real time garbage collection, and stack allocation of most function contexts while maintaining full closure semantics.
...
_Dynamism_:
Most graphical synthesis environments use statically allocated unit generators.
...
_Brevity_:
In SuperCollider, symmetries in a patch can be exploited by either multichannel expansion or programmatic patch building.
...
None of them have the dynamic flexibility of SuperCollider’s complete programming environment.
Look through the SuperCollider help files and examples and see for yourself.
