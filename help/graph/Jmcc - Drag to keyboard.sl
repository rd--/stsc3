...
{ :tr |
	var sr = TExpRand(300, 3000) + [-0.6, 0.6];
	var p1 = LfPulse(TExpRand(0.1, 1), 0, 0.3) * 0.2 + 0.02;
	var p2 = LfPulse(TExpRand(0.1, 12), 0, 0.4) * 0.2 + 0.2;
	var p3 = LfPulse(TExpRand(0.1, 12), 0, 0.7) * 0.2 + p2;
