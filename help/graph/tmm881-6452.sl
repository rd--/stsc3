...
var tr = Impulse(100 * Line(0.1, 10, 15, 2), 0);
Pan2(GrainSin(2, tr, 1, TRand(322, 3222, tr), WhiteNoise() * 0.6, -1, 2048), 0, 1 / 64)
...
var f = { :p |
	...
	var o1 = { SinOsc(Rand(f1, f2) * Line(l1, l2, 60, 2), 0) }.dup(128).sum;
	var o2 = { SinOsc(Rand(f1, f2) * Line(l2, l1, 60, 2), 0) }.dup(128).sum;
	Pan2(o1 + o2, 0, 1 / 128)
};
...
var f = { :p |
	...
	var o1 = { SinOsc(TRand(f1, f2, Impulse(10, 0)) * Line(l1, l2, 60, 2), 0) }.dup(128).sum;
	var o2 = { SinOsc(TRand(f1, f2, Impulse(10, 0)) * Line(l1, l2, 60, 2), 0) }.dup(128).sum;
	Pan2(o1 + o2, 0, 1 / 128)
};
