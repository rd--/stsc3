...
Pan2(SinGrain(tr, 0.05, TrRand(tr, 322, 3222)) * 0.1, 0, 1)

(* https://scsynth.org/t/6452 *)
var tr = Impulse(100 * Line(0.1, 10, 15, 2), 0);
Pan2(GrainSin(2, tr, 1, TrRand(tr, 322, 3222), WhiteNoise() * 0.6, -1, 2048), 0, 1 / 64).transposed.sum

(* https://scsynth.org/t/6452 *)
var tr = Impulse(100 * Line(0.1, 10, 30, 2), 0);
Pan2(GrainFm(2, tr, 10, TrRand(tr, 322, 3222), TrRand(tr, 322, 3222), 1, WhiteNoise() * 0.6, -1, 128), 0, 1 / 64).sum

(* https://scsynth.org/t/6452 *)
var tr = Impulse(100 * Line(0.1, 10, 60, 2), 0);
Pan2(GrainFm(2, tr, 10, TrRand(tr, 322, 3222), TrRand(tr, 322, 3222, Impulse(100, 0)), 1, WhiteNoise() * 0.6, -1, 128), 0, 1 / 64)

(* https://scsynth.org/t/6452 *)
var tr = Impulse(1 * Line(0.1, 10, 90, 2), 0);
Pan2(GrainFm(2, tr, 0.1, TrRand(tr, 322, 3222), TrRand(tr, 322, 3222), 1, WhiteNoise() * 0.6, -1, 128), 0, 1 / 64).sum
...
var f = { :p |
	...
	var o1 = { SinOsc(TrRand(Impulse(10, 0), f1, f2) * Line(l1, l2, 60, 2), 0) } !+ 128;
	var o2 = { SinOsc(TrRand(Impulse(10, 0), f1, f2) * Line(l1, l2, 60, 2), 0) } !+ 128;
	EqPan2(o1 + o2, 0) / 128
};
