...
Pan2(SinGrain(tr, 0.05, Rand(tr, 322, 3222)) * 0.1, 0, 1)
...
Pan2(GrainFm(2, tr, 10, Rand(tr, 322, 3222), Rand(tr, 322, 3222, Impulse(100, 0)), 1, WhiteNoise() * 0.6, -1, 128), 0, 1 / 64)
...
var f = { :p |
	...
	var o1 = { SinOsc(Rand(Impulse(10, 0), f1, f2) * Line(l1, l2, 60, 2), 0) } !+ 128;
	var o2 = { SinOsc(Rand(Impulse(10, 0), f1, f2) * Line(l1, l2, 60, 2), 0) } !+ 128;
	EqPan2(o1 + o2, 0) / 128
};
