...
var c, d, p, o;
c = DmdFor(0.004, 0, mod(Ser(infinity(Float), 1, [1, 2]), DmdFor(8.192, 0, Seq(infinity(Float), mul(to(1, 6), 75)))));
d = HPF(MantissaMask(c, 3), 5);
p = mul([250, 200], lag(DmdFor(4.096, 0, Seq(infinity(Float), fdiv([4, 6, 5, 5, 5, 5, 3], 4))), 0.1));
